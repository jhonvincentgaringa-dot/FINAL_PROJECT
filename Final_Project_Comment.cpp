...
int main() {
    ...
    do {
        ...
        // Bug Fix: Check if students are registered for choices 3 to 7
        ...
        switch (choice) {
            // lines 80-110 for the student registration
        case 1:
        ...
        case 2:
            // lines 114-115 for displaying the student registered
            displayStudents(head);
            break;

        case 3:
        {
            // lines 119-136 for finding student details
        ...
        case 4:
            // line 139-144 for editing student details
...
// line 190-197 Function to check if a string contains any numeric digits
int isNumeric(const char *str) {
    if (*str == '\0') return 0;
    while (*str) {
...
// ALGORITHM 2: String Traversal and Validation
// line 201-207 Function to check if a string contains any numeric digits
int hasNumber(const char *str) {
    while (*str) {
...
// line 211-223 for the student registration 
struct Student *createStudent(const char *id, const char *name, const char *course, const char *major) {
...
// line 226-238 for adding student
void addStudent(struct Student **head, const char *id, const char *name, const char *course, const char *major) {
...
// Lines 243-256 visit every node in the list
...
// Lines 261-270 iterate through the list until the target ID is found
...
// line 274-307 for edit existing student data
void editStudent(struct Student *head, const char *id) {
...
// line 311-339 for deleting student data
void deleteStudent(struct Student **head, const char *id) {
    struct Student *current = *head;
...
//line 343-360 for swaping student data
void swapStudentData(struct Student *a, struct Student *b) {
...
// line 366-387 for sorting by id
void bubbleSortStudents(struct Student *head) {
    int swapped;
    struct Student *ptr1;
...
// line 394-416 for sorting by name
void selectionSortByName(struct Student *head) {
