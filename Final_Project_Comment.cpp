...
int main() {
    ...
    // line 43-48 for the following local variables and pointers are allocated on the Call Stack.
    ...
    do {
        ...
        printf("3. " GREEN "Find Student by ID (Linear Search)\n" RESET);
        printf("4. " GREEN "Edit Student by ID\n" RESET);
        printf("5. " BLUE "Sort Students by ID (Bubble Sort)\n" RESET);
        printf("6. " BLUE "Sort Students by Name (Selection Sort)\n" RESET);
        ...
        // line 77-80 for the students are registered for choices 3 to 7
        ...
        switch (choice) {
            ...
            // lines 85-114 for the student registration
        case 1:
        ...
        case 3:
        {
            ...
            // Execute ALGORITHM 6: Linear Search
        ...
        case 5:
            ...
            printf(GREEN BOLD "Students sorted successfully by ID (Bubble Sort)!\n" RESET);
            break;

        case 6:
            // line 158-160 for student sorted by name
            selectionSortByName(head);
            printf(GREEN BOLD "Students sorted successfully by Name (Selection Sort)!\n" RESET);
            break;
    ...
    // line 182-188 for memory location
...
// line 195-202 Function to check if a string contains any numeric digits
int isNumeric(const char *str) {
    if (*str == '\0') return 0;
    while (*str) {
...
// ALGORITHM 2: String Traversal and Validation
// line 206-212 Function to check if a string contains any numeric digits
int hasNumber(const char *str) {
    while (*str) {
...
// line 216-228 for the student registration 
struct Student *createStudent(const char *id, const char *name, const char *course, const char *major) {
...
// line 232-243 for adding student
void addStudent(struct Student **head, const char *id, const char *name, const char *course, const char *major) {
...
// Lines 248-261 visit every node in the list
...
// Lines 266-275 iterate through the list until the target ID is found
...
// line 279-312 for edit existing student data
void editStudent(struct Student *head, const char *id) {
...
// line 316-344 for deleting student data
void deleteStudent(struct Student **head, const char *id) {
    struct Student *current = *head;
...
//line 348-365 for swaping student data
void swapStudentData(struct Student *a, struct Student *b) {
...
// line 371-392 for sorting by id
void bubbleSortStudents(struct Student *head) {
    int swapped;
    struct Student *ptr1;
    ...
    do {
        ...
        while (ptr1->next != lptr) {
            ...
            if (strcmp(ptr1->studentId, ptr1->next->studentId) > 0) {
...
// line 399-421 for sorting by name
void selectionSortByName(struct Student *head) {
