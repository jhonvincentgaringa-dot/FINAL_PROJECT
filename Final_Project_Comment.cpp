...
int main() {
    ...
    do {
        ...
        switch (choice) {
            // lines 83-117 for the student registration
        case 1:
            ...
            if (findStudent(head, id) != NULL) {
                printf(RED "Error: ID same to other.\n" RESET);
                break;
            }
        ...
        case 2:
            // lines 121-122 for displaying the student registered
            displayStudents(head);
            break;

        case 3:
        {
            // lines 127-143 for finding student details
        ...
        case 4:
            // line 147-151 for editing student details
...
// line 214-226 for the student registration 
struct Student *createStudent(const char *id, const char *name, const char *course, const char *major) {
...
// line 229-240 for adding student
void addStudent(struct Student **head, const char *id, const char *name, const char *course, const char *major) {
...
// Lines 244-257 visit every node in the list
...
// Lines 262-271 iterate through the list until the target ID is found
...
// ALGORITHM  1: Linear Search
// line 275-308 for edit existing student data
void editStudent(struct Student *head, const char *id) {
...
//line 342-359 for swaping student data
void swapStudentData(struct Student *a, struct Student *b) {
