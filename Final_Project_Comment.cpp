...
// line 192-199 Function to check if a string contains any numeric digits
int isNumeric(const char *str) {
    if (*str == '\0') return 0;
    while (*str) {
...
// line 201-208 Function to check if a string contains any numeric digits
int hasNumber(const char *str) {
    while (*str) {
...
// line 226-237 for adding student
void addStudent(struct Student **head, const char *id, const char *name, const char *course, const char *major) {
...
// Lines 240-254 visit every node in the list
...
// Lines 259-268 iterate through the list until the target ID is found
...
// ALGORITHM  1: Linear Search
// line 272-305 for edit existing student data
void editStudent(struct Student *head, const char *id) {
...
// line 308-336 for deleting student data
void deleteStudent(struct Student **head, const char *id) {
    struct Student *current = *head;
...
//line 338-356 for swaping student data
void swapStudentData(struct Student *a, struct Student *b) {
...
// line 362-383 for sorting by id
void bubbleSortStudents(struct Student *head) {
    int swapped;
    struct Student *ptr1;
...
// line 390-412 for sorting by name
void selectionSortByName(struct Student *head) {
