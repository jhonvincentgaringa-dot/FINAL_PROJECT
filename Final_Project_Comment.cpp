...
int main() {
    ...
    do {
        ...
        case 2:
            // lines 123-124 for displaying the student registered
            displayStudents(head);
            break;

        case 3:
        {
            // lines 129-145 for finding student details
        ...
        case 4:
            // line 149-153 for editing student details
...
// line 197-204 Function to check if a string contains any numeric digits
int isNumeric(const char *str) {
    if (*str == '\0') return 0;
    while (*str) {
...
// line 207-213 Function to check if a string contains any numeric digits
int hasNumber(const char *str) {
    while (*str) {
...
// line 216-225 for the student registration 
struct Student *createStudent(const char *id, const char *name, const char *course, const char *major) {
...
// Lines 245-259 visit every node in the list
...
// Lines 264-273 iterate through the list until the target ID is found
...
// ALGORITHM  1: Linear Search
// line 277-310 for edit existing student data
void editStudent(struct Student *head, const char *id) {
...
// line 313-341 for deleting student data
void deleteStudent(struct Student **head, const char *id) {
    struct Student *current = *head;
...
//line 344-361 for swaping student data
void swapStudentData(struct Student *a, struct Student *b) {
...
// line 367-388 for sorting by id
void bubbleSortStudents(struct Student *head) {
    int swapped;
    struct Student *ptr1;
...
// line 395-417 for sorting by name
void selectionSortByName(struct Student *head) {
